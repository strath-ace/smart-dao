...
# Earthquake time
earthquake_timestamp = to_timestamp("2023-02-06 01:17:00")
...
x = []
min_val_li = []
words = ["earthquake", "türkiye", "terremoto", "tsunami"]
twitter_words = load_json("./turkey_23-02-06/clean_twitter.json")
for word in words:
    temp = []
    split_x = []
    split_y = []
...
usgs_dates = load_json("./turkey_23-02-06/clean_usgs.json")
...
add_line("2023-02-06 04:43:00", "Copernicus Activation")
add_line("2023-02-06 04:04:00", "ICSMD Activation")
...
plt.title("Turkey Earthquake 6 Feb 2023")
plt.ylabel("Number of warnings")
plt.xlabel("Time since disaster (Hours)")
plt.savefig("turkey_2023_02_06")
