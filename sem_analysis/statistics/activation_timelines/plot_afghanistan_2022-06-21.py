...
add_line("2022-06-22 14:47:00", "Copernicus Activation")
add_line("2022-06-22 10:46:00", "ICSMD Activation")


plt.stackplot(x, tweets_sum_li, all_stuff[0], alpha=0.6, labels=["100s of Tweets with Keywords", "USGS 'Did you feel it' Notifications"])    
