...
add_line("2022-11-22 09:26:00", "Copernicus Activation", "orange")
add_line("2022-11-22 12:54:00", "ICSMD Activation", "blue")


colours_li = ["darkviolet", "crimson","green"]
plt.stackplot(x, tweets_sum_li, media_sum_li, all_stuff[0], colors=colours_li, alpha=0.5, labels=["100s of Tweets with Keywords", "Media about event", "USGS 'Did you feel it' Notifications"])    
