...
from run_func_DiD import *

from ..contracts.DiD_plusAssets.DiD import *

from ..contracts.DiD_plusAssets.assetStorage import *

# Prints division line just for layout
def line(info):
    print()
    print("--------------  {}".format(info))
    print()
...
def contractDeployment(algod_client, acc1_pkey):
    ...
    global_schema = transaction.StateSchema(3, 3)
