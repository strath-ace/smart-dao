...
title_string = "Absolute number of connections (Computed over "+str(total_timer)+" hours with "+str(len(li_sat_names))+" oneweb satellites)"
...
title_string = "How connected to the number of unqiue sats (Computed over "+str(total_timer)+" hours with "+str(len(li_sat_names))+" oneweb satellites)"
plt.title(title_string)

plt.savefig(save_location+"/num_of_connections_percentage_of_max.png")
plt.savefig(save_location+"/../../data/connections_oneweb.png")
# plt.show()
