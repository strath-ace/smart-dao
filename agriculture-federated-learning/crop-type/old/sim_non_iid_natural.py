...
from core import Net, train, test, apply_transforms
...
def main():
    ...
    save_location = os.path.join(file_location, "..", "data", "non-iid-natural")
    ...
    for j in range(1,params_config["TRAINING_ITERATIONS"]+1):
        ...
        if not os.path.exists(file_name):
            ...
            for i in TARGET_NUM_CLIENTS:
                ...
                partitioner = NaturalIdPartitioner(partition_by="users")
                mnist_fds = FederatedDataset(dataset="femnist", partitioners={"train": partitioner})
